        ...
        <form onSubmit={handleAuth} className="space-y-5 relative z-10">
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between ml-1">
              <label className="text-sm md:text-sm md:text-xs font-bold uppercase tracking-widest text-muted">Password</label>
              <button 
                type="button"
                className="text-sm md:text-sm md:text-xs font-bold text-primary hover:text-primary-2 transition-colors uppercase min-h-[44px]"
