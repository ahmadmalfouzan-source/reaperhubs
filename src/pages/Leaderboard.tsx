            ...
            <table className="w-full text-left border-collapse min-w-[600px]">
              <thead>
                <tr className="bg-surface-2/30 border-b border-border/50">
                  <th className="px-8 py-6 text-sm font-bold uppercase tracking-[0.3em] text-muted">Rank</th>
                  <th className="px-8 py-6 text-sm font-bold uppercase tracking-[0.3em] text-muted">Agent</th>
                  <th className="px-8 py-6 text-sm font-bold uppercase tracking-[0.3em] text-muted text-center">Clearance</th>
                  <th className="px-8 py-6 text-sm font-bold uppercase tracking-[0.3em] text-muted text-right">XP</th>
                  <th className="px-8 py-6 text-sm font-bold uppercase tracking-[0.3em] text-muted text-right">Credits</th>
                </tr>
              </thead>
                        ...
                        <Link to={`/profile/${user?.username}`} className="flex items-center gap-4 group/user">
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-2 mt-1">
                              ...
                              <span className="text-sm text-muted font-bold uppercase tracking-widest">Active Operative</span>
                            </div>
                          </div>
                        </Link>
                      </td>
