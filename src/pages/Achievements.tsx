  ...
  return (
    <div className="space-y-12 max-w-6xl mx-auto px-4 py-12 animate-in fade-in duration-700">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b border-border/50 pb-10">
        <div className="space-y-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-primary/10 rounded-full border border-primary/20 text-sm md:text-sm md:text-xs font-bold text-primary uppercase tracking-[0.2em]">
            Service Record
          </div>
        ...
        <div className="bg-surface border border-border rounded-3xl p-6 min-w-[240px] space-y-4 shadow-2xl relative overflow-hidden group">
           ...
           <div className="flex justify-between items-center text-sm md:text-xs font-bold uppercase tracking-widest text-muted">
           ...
           <p className="text-sm md:text-sm md:text-xs text-muted text-center font-bold uppercase tracking-widest pt-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
        ...
        <div className="lg:col-span-1 space-y-8">
           <section className="space-y-4">
              <h3 className="text-sm md:text-sm md:text-xs font-bold uppercase tracking-[0.2em] text-muted px-2">Operational Sectors</h3>
              <div className="flex flex-col gap-2">
                 <button className="flex items-center gap-3 px-5 py-3 rounded-2xl bg-primary text-black font-bold text-sm md:text-xs uppercase tracking-widest shadow-lg shadow-primary/20 transition-all">
                    <History size={16} /> All Targets
                 </button>
                 {categories.map(cat => (
                   <button key={cat.id} className="flex items-center gap-3 px-5 py-3 rounded-2xl bg-surface-2 border border-border text-muted hover:text-white hover:border-primary/50 transition-all font-bold text-sm md:text-xs uppercase tracking-widest group">
           ...
           <section className="bg-surface border border-border rounded-3xl p-6 space-y-4">
              <div className="flex items-center gap-2 text-sm md:text-xs font-bold uppercase text-primary">
                 <Zap size={14} className="fill-current" />
                 Tactical Advantage
              </div>
              <p className="text-sm md:text-sm md:text-xs text-muted leading-relaxed italic">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-col h-full space-y-4 relative z-10">
                    ...
                    {unlockedAt && (
                      <div className="text-sm md:text-sm md:text-xs text-muted text-right font-medium">
